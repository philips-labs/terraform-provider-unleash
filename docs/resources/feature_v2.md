...
- `context_name` (String) Constraint context name. Must be a context field defined in Unleash or one of the built-in values: `appName`, `currentTime`, `environment`, `remoteAddress`, `sessionId`, `userId`.
